...
namespace IndexActiveDirectoryToSearch.Frameworks.ActiveDirectory
{
    public class ADUserDetail
    {
        ...
        public string SafeLoginName
        {
            get { return _loginName.Replace(" ", "").ToString(); }
        }
        ...
        private static object GetSpecialProperty(DirectoryEntry userDetail, String propertyName)
        {
            if (userDetail.Properties.Contains(propertyName))
            {
